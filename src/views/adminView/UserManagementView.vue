                ...
                <div class="px-6 py-5">
                  ...
                  <div class="grid grid-cols-2 gap-2.5 mb-4">
                    <button @click="viewDetails"
                      ...
                      <div class="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" :class="isDarkMode ? 'bg-gray-600' : 'bg-gray-200'">
                    ...
                    <button @click="goToDashboard(selectedUser)"
                      ...
                      <div class="w-8 h-8 rounded-lg bg-blue-700/50 flex items-center justify-center shrink-0">
                    ...
                    <button @click="goToUserSetting(selectedUser)"
                      ...
                      <div class="w-8 h-8 rounded-lg bg-indigo-700/50 flex items-center justify-center shrink-0">
                        <svg class="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <Transition name="expand">
                    <div v-if="showDetails" class="mt-4 rounded-xl border p-4" :class="[themeClasses.inputBackground, themeClasses.border]">
                      ...
                      <dl class="grid grid-cols-1 gap-2.5 text-sm">
                        <div class="flex items-center gap-2">
                          <dt class="font-medium w-20 shrink-0" :class="themeClasses.textSecondary">{{ $t('admin.name') }}</dt>
