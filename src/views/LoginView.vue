  ...
  <div
    ...
    <div class="relative w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl space-y-5 sm:space-y-7 animate-fade-in">
      ...
      <div class="text-center">
        ...
        <h1 class="bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-700 bg-clip-text text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight text-transparent">
          {{ $t('auth.welcomeBack') }}
        </h1>
      ...
      <div class="rounded-2xl sm:rounded-3xl border border-white/60 bg-white/75 p-5 sm:p-7 lg:p-10 shadow-2xl shadow-indigo-100/60 backdrop-blur-xl">
        ...
        <form @submit.prevent="handleLogin" novalidate class="space-y-4 sm:space-y-5">
          ...
          <div class="flex items-center justify-between pt-0.5">
            <label for="remember-me" class="flex cursor-pointer items-center gap-3 group">
              <div class="relative flex-shrink-0">
                ...
                <div class="h-6 w-11 rounded-full bg-gray-200 shadow-inner transition-all duration-300 peer-checked:bg-gradient-to-r peer-checked:from-indigo-500 peer-checked:to-purple-500 peer-focus-visible:ring-2 peer-focus-visible:ring-indigo-400 peer-focus-visible:ring-offset-1"></div>
            ...
            <div class="group/tip relative ml-2 flex-shrink-0">
              ...
              <div class="pointer-events-none absolute bottom-6 right-0 z-20 w-max max-w-[13rem] rounded-xl bg-gray-800 px-3 py-2 text-xs text-white opacity-0 shadow-xl transition-all duration-200 group-hover/tip:opacity-100">
          ...
          <div class="space-y-3 pt-1 sm:space-y-3.5">
            ...
            >
              <!-- Shimmer overlay -->
              <span class="pointer-events-none absolute inset-0 -translate-x-full bg-gradient-to-r from-white/0 via-white/20 to-white/0 transition-transform duration-700 group-hover:translate-x-full" aria-hidden="true"></span>
