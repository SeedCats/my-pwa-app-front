<template>
    <div class="absolute inset-0 flex flex-col overflow-hidden w-full" :class="themeClasses.background">

        <!-- ── Chat Header ─────────────────────────────────────────────── -->
        <div class="px-4 sm:px-6 lg:px-8 py-3 border-b shrink-0 backdrop-blur-md z-10 flex items-center gap-3"
            ...
            <div class="relative shrink-0 group cursor-default">
                <img v-if="receiverIcon" :src="receiverIcon" alt="Provider Icon"
                     class="w-10 h-10 rounded-full object-cover shadow-sm ring-2 ring-white dark:ring-gray-800" />
                <div v-else
                     class="w-10 h-10 rounded-full flex items-center justify-center shadow-sm ring-2 ring-white dark:ring-gray-800"
            ...
            <div class="flex-1 min-w-0">
                <h1 class="text-[14px] font-bold truncate tracking-tight leading-tight" :class="themeClasses.textPrimary">
